...
function DashAboutMeta() {
  ...
  useEffect(() => {
    try {
      fetch(`${apiUrl}/api/metatags/about`)
        .then((res) => res.json())
        .then((data) => {
          setId(data._id);
          setForm({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(`${apiUrl}/api/metatags/about/${id}`, {
        method: "PUT",
        headers: {
